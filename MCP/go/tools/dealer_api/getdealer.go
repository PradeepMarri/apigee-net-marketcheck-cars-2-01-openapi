...
func GetdealerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/dealer/car/%s%s", cfg.BaseURL, id, queryString)
...
func CreateGetdealerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_dealer_car_id",
