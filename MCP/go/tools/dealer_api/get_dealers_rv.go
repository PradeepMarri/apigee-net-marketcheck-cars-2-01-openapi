...
func Get_dealers_rvHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/dealers/rv%s", cfg.BaseURL, queryString)
...
func CreateGet_dealers_rvTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_dealers_rv",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_dealers_rvHandler(cfg),
	}
}
