...
func Get_dealers_motorcycleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/dealers/motorcycle%s", cfg.BaseURL, queryString)
...
func CreateGet_dealers_motorcycleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_dealers_motorcycle",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_dealers_motorcycleHandler(cfg),
	}
}
