...
func Get_dealer_rv_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/dealer/rv/%s%s", cfg.BaseURL, id, queryString)
...
func CreateGet_dealer_rv_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_dealer_rv_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_dealer_rv_idHandler(cfg),
	}
}
