...
func Get_dealers_heavy_equipmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/dealers/heavy-equipment%s", cfg.BaseURL, queryString)
...
func CreateGet_dealers_heavy_equipmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_dealers_heavy-equipment",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_dealers_heavy_equipmentHandler(cfg),
	}
}
