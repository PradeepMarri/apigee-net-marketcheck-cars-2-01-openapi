...
func Get_dealer_car_uk_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/dealer/car/uk/%s%s", cfg.BaseURL, id, queryString)
...
func CreateGet_dealer_car_uk_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_dealer_car_uk_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_dealer_car_uk_idHandler(cfg),
	}
}
