...
func Get_search_heavy_equipment_auto_completeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/search/heavy-equipment/auto-complete%s", cfg.BaseURL, queryString)
...
func CreateGet_search_heavy_equipment_auto_completeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_heavy-equipment_auto-complete",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_search_heavy_equipment_auto_completeHandler(cfg),
	}
}
