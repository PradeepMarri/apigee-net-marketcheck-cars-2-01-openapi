...
func Get_search_rv_auto_completeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/search/rv/auto-complete%s", cfg.BaseURL, queryString)
...
func CreateGet_search_rv_auto_completeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_rv_auto-complete",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_search_rv_auto_completeHandler(cfg),
	}
}
