...
func Get_search_rv_uk_activeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["mtplm"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("mtplm=%v", val))
		}
		if val, ok := args["sub_category"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("sub_category=%v", val))
		}
		if val, ok := args["availability_status"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("availability_status=%v", val))
		}
		if val, ok := args["berths"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("berths=%v", val))
		}
		if val, ok := args["inventory_type"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("inventory_type=%v", val))
		}
		if val, ok := args["width_range"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("width_range=%v", val))
		}
		if val, ok := args["exterior_length_range"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("exterior_length_range=%v", val))
		}
		if val, ok := args["interior_length_range"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("interior_length_range=%v", val))
		}
		if val, ok := args["drive_type"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("drive_type=%v", val))
		}
		if val, ok := args["steering"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("steering=%v", val))
		}
		if val, ok := args["chassis"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("chassis=%v", val))
		}
		...
		url := fmt.Sprintf("%s/search/rv/uk/active%s", cfg.BaseURL, queryString)
		...
		var result models.UKRVSearchResponse
...
func CreateGet_search_rv_uk_activeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_rv_uk_active",
		...
		mcp.WithString("category", mcp.Description("Filter RV listings on category")),
		...
		mcp.WithString("mtplm", mcp.Description("To filter rv on mtplm")),
		mcp.WithString("sub_category", mcp.Description("To filter rv on their sub-category")),
		mcp.WithString("availability_status", mcp.Description("To filter rv on their availability_status")),
		mcp.WithString("berths", mcp.Description("To filter rv on their berths")),
		mcp.WithString("inventory_type", mcp.Description("To filter listing on their condition. Either used or new")),
		mcp.WithString("width_range", mcp.Description("width range to filter listings on width in the range given. Range to be given in the format - min-max e.g. 4-8")),
		mcp.WithString("exterior_length_range", mcp.Description("width range to filter listings on exterior_length in the range given. Range to be given in the format - min-max e.g. 4-8")),
		mcp.WithString("interior_length_range", mcp.Description("width range to filter listings on interior_length in the range given. Range to be given in the format - min-max e.g. 4-8")),
		mcp.WithString("drive_type", mcp.Description("To filter rv on their drive_type")),
		mcp.WithString("steering", mcp.Description("To filter rv on their steering")),
		mcp.WithString("chassis", mcp.Description("To filter rv on their chassis")),
		mcp.WithString("transmission", mcp.Description("To filter listing on their transmission")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Get_search_rv_uk_activeHandler(cfg),
	}
}
