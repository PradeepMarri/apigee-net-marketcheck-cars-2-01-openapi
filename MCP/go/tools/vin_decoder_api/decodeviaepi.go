...
func DecodeviaepiHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/decode/car/epi/%s/specs%s", cfg.BaseURL, vin, queryString)
...
func CreateDecodeviaepiTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_decode_car_epi_vin_specs",
		mcp.WithDescription("EPI VIN Decoder"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DecodeviaepiHandler(cfg),
	}
}
