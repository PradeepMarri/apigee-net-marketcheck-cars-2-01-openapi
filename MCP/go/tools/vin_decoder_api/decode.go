...
func DecodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/decode/car/%s/specs%s", cfg.BaseURL, vin, queryString)
...
func CreateDecodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_decode_car_vin_specs",
		mcp.WithDescription("VIN Decoder"),
