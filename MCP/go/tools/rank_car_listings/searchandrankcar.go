...
func SearchandrankcarHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/search/car/active/rank%s", cfg.BaseURL, queryString)
...
func CreateSearchandrankcarTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_search_car_active_rank",
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchandrankcarHandler(cfg),
	}
}
