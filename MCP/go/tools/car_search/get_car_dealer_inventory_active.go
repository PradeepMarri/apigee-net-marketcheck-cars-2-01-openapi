...
func Get_car_dealer_inventory_activeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/car/dealer/inventory/active%s", cfg.BaseURL, queryString)
...
func CreateGet_car_dealer_inventory_activeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_car_dealer_inventory_active",
		mcp.WithDescription("Get dealers active inventory"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_car_dealer_inventory_activeHandler(cfg),
	}
}
