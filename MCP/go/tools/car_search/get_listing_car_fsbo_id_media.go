...
func Get_listing_car_fsbo_id_mediaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listing/car/fsbo/%s/media%s", cfg.BaseURL, id, queryString)
...
func CreateGet_listing_car_fsbo_id_mediaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_listing_car_fsbo_id_media",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_listing_car_fsbo_id_mediaHandler(cfg),
	}
}
