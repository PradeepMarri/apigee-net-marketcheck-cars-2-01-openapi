...
func GetlistingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listing/car/%s%s", cfg.BaseURL, id, queryString)
...
func CreateGetlistingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_listing_car_id",
