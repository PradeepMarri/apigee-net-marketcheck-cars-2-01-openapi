...
func Get_listing_car_fsbo_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listing/car/fsbo/%s%s", cfg.BaseURL, id, queryString)
...
func CreateGet_listing_car_fsbo_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_listing_car_fsbo_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_listing_car_fsbo_idHandler(cfg),
	}
}
