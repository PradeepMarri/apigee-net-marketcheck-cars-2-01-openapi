...
func Get_listing_car_auction_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listing/car/auction/%s%s", cfg.BaseURL, id, queryString)
...
func CreateGet_listing_car_auction_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_listing_car_auction_id",
		mcp.WithDescription("Listing by id"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_listing_car_auction_idHandler(cfg),
	}
}
