...
func SearchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["co2_emissions"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("co2_emissions=%v", val))
		}
		if val, ok := args["insurance_group"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("insurance_group=%v", val))
		}
		if val, ok := args["vehicle_registration_mark"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("vehicle_registration_mark=%v", val))
		}
		if val, ok := args["vehicle_registration_date_range"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("vehicle_registration_date_range=%v", val))
		}
		...
		if val, ok := args["exclude_write_off_category"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("exclude_write_off_category=%v", val))
		}
		...
		if val, ok := args["powertrain_type"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("powertrain_type=%v", val))
		}
		if val, ok := args["client_filters"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("client_filters=%v", val))
		}
		if val, ok := args["boost"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("boost=%v", val))
		}
		if val, ok := args["car_location_seller_name"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car_location_seller_name=%v", val))
		}
		if val, ok := args["car_location_street"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car_location_street=%v", val))
		}
		if val, ok := args["car_location_city"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car_location_city=%v", val))
		}
		if val, ok := args["car_location_county"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car_location_county=%v", val))
		}
		if val, ok := args["car_location_zip"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car_location_zip=%v", val))
		}
		if val, ok := args["car_location_latitude"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car_location_latitude=%v", val))
		}
		if val, ok := args["car_location_longitude"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car_location_longitude=%v", val))
		}
		if val, ok := args["price_change"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("price_change=%v", val))
		}
		...
		if val, ok := args["uvc_id"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("uvc_id=%v", val))
		}
		...
		if val, ok := args["min_photo_links"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("min_photo_links=%v", val))
		}
		if val, ok := args["min_photo_links_cached"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("min_photo_links_cached=%v", val))
		}
		if val, ok := args["match"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("match=%v", val))
		}
		if val, ok := args["ulez_compliant"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("ulez_compliant=%v", val))
		}
		...
		url := fmt.Sprintf("%s/search/car/uk/active%s", cfg.BaseURL, queryString)
...
func CreateSearchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_car_uk_active",
		mcp.WithDescription("Gets active car listings in UK for the given search criteria"),
		...
		mcp.WithString("co2_emissions", mcp.Description("CO2 emissions")),
		mcp.WithString("insurance_group", mcp.Description("Insurance Group")),
		mcp.WithString("vehicle_registration_mark", mcp.Description("Vehicle Registration Mark")),
		mcp.WithString("vehicle_registration_date_range", mcp.Description("Vehicle registration date range to be given in the format [YYYYMMDD] - min-max e.g. 20190523-20190623")),
		...
		mcp.WithString("exclude_write_off_category", mcp.Description("To exclude write off category")),
		...
		mcp.WithString("powertrain_type", mcp.Description("To filter on powertrain_type")),
		mcp.WithBoolean("client_filters", mcp.Description("Flag to add explicit filters set on client level in solr")),
		mcp.WithBoolean("boost", mcp.Description("Flag to sort listings based on client filter score in solr")),
		mcp.WithString("car_location_seller_name", mcp.Description("Filter cars on seller name")),
		mcp.WithString("car_location_street", mcp.Description("Filter cars on street name")),
		mcp.WithString("car_location_city", mcp.Description("Filter cars on city")),
		mcp.WithString("car_location_county", mcp.Description("Filter cars on county")),
		mcp.WithString("car_location_zip", mcp.Description("To filter listing on car ZIP around which they are listed")),
		mcp.WithString("car_location_latitude", mcp.Description("Latitude component of car location")),
		mcp.WithString("car_location_longitude", mcp.Description("Longitude component of car location")),
		mcp.WithString("price_change", mcp.Description("Query to filter listings based on their positive and negative price change")),
		...
		mcp.WithString("uvc_id", mcp.Description("To filter on uvc id")),
		...
		mcp.WithString("min_photo_links", mcp.Description("Filter listings based by number of photo links within given range")),
		mcp.WithString("min_photo_links_cached", mcp.Description("Filter listings based by number of cached photo links within given range")),
		...
		mcp.WithBoolean("ulez_compliant", mcp.Description("Filter listings based on drive into ultra low emmition zone")),
	)
