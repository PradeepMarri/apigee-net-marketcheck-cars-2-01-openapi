...
func Get_search_car_recentsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/search/car/recents%s", cfg.BaseURL, queryString)
...
func CreateGet_search_car_recentsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_car_recents",
		mcp.WithDescription("Gets Recent car listings for the given search criteria"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_search_car_recentsHandler(cfg),
	}
}
